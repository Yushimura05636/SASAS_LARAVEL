...
//>>>>
    ...
    )
    {
        ...
        try {
            ...
            // return response()->json([
            //     'message' => 'Both Customer, Personality, and User Account saved successfully',
            //     'customer' => new CustomerResource($customerResponse), // Use resource class
            //     'personality' => new PersonalityResource($personalityResponse), // Use resource class
            //     'user_account' => new UserResource($userAccountResponse), // Assuming you have a UserAccountResource
            // ], Response::HTTP_OK);
