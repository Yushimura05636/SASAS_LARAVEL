...
Route::get('GROUP_RETREIVE/all', [CustomerGroupController::class, 'getGroupWithMembers']);
Route::get('GROUP_RETREIVE/groupNameAndCollector', [CustomerController::class, 'getGroupOnlyNameAndCollector']);
